...
Rails.application.configure do
  ...
  # TLS: terminate at the reverse proxy by default; disable with RAILS_ASSUME_SSL=false / RAILS_FORCE_SSL=false
  # for plain-HTTP smoke tests only (never in public production).
